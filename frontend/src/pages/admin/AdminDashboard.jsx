      ...
      <header style={{ marginBottom: "2.5rem", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <div style={{ display: "flex", gap: 10 }}>
           <div style={{ padding: "8px 15px", background: "#10B98115", borderRadius: 12, border: "1px solid #10B98130", display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <span style={{ fontSize: "0.8rem", fontWeight: 900, color: "#10B981" }}>Backend: {data.kpis.system_health}</span>
           </div>
        </div>
      </header>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "1.5rem", marginBottom: "2.5rem" }}>
        <div style={{ background: "#1E293B", padding: "1.8rem", borderRadius: 28, color: "#fff", display: "flex", justifyContent: "space-between", alignItems: "start" }}>
           <div>
              ...
              <h2 style={{ margin: "5px 0", fontSize: "2.2rem", fontWeight: 950 }}>{data.kpis.total_users}</h2>
        ...
        <SystemMetric label="Charge CPU" value={`${data.system.cpu}%`} icon={<Cpu size={16} color="#3B82F6" />} color="#3B82F6" />
        <SystemMetric label="Mémoire RAM" value={`${data.system.ram}%`} icon={<Database size={16} color="#8B5CF6" />} color="#8B5CF6" />
        <SystemMetric label="Latence API" value={data.system.latency} icon={<Zap size={16} color="#F59E0B" />} color="#F59E0B" />
        <SystemMetric label="Disponibilité" value={data.kpis.uptime} icon={<Globe size={16} color="#10B981" />} color="#10B981" />
      </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
           <div style={{ background: "#fff", borderRadius: 32, padding: "2rem", border: "1px solid #E2E8F0" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }}>
                 <button style={S.actionBtn}><Users size={18} /> Gérer Utilisateurs</button>
                 <button style={S.actionBtn}><ShieldAlert size={18} /> Audit Sécurité</button>
                 <button style={S.actionBtn}><Terminal size={18} /> Voir Logs</button>
                 <button style={S.actionBtn}><Settings size={18} /> Config Système</button>
              </div>
           </div>
